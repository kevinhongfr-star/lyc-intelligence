...
var RemoteConfigLoader = /** @class */ (function () {
    ...
    Object.defineProperty(RemoteConfigLoader.prototype, "remoteConfig", {
        get: function () {
            var _a, _b;
            return (_b = (_a = globals_2.assignableWindow._POSTHOG_REMOTE_CONFIG) === null || _a === void 0 ? void 0 : _a[this._instance.config.token]) === null || _b === void 0 ? void 0 : _b.config;
        },
        enumerable: false,
        configurable: true
    });
    RemoteConfigLoader.prototype._loadRemoteConfigJs = function (cb) {
        var _this = this;
        var _a, _b, _c;
        if ((_a = globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.loadExternalDependency) {
            (_c = (_b = globals_2.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.loadExternalDependency) === null || _c === void 0 ? void 0 : _c.call(_b, this._instance, 'remote-config', function () {
        ...
        try {
            ...
            this._loadRemoteConfigJs(function (config) {
                if (!config) {
                    ...
                    _this._loadRemoteConfigJSON(function (response) {
                        _this._onRemoteConfig(response.json, response);
    ...
    RemoteConfigLoader.prototype._onRemoteConfig = function (config, response) {
        var _a;
        if (!config && response) {
        ...
        if ((config === null || config === void 0 ? void 0 : config.hasFeatureFlags) !== false && !this._instance.config.advanced_disable_feature_flags_on_first_load) {
            try {
