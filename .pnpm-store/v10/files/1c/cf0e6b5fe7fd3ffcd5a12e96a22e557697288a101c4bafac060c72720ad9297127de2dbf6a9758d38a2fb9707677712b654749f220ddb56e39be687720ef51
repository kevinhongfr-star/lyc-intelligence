...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        if (this._extensionEventPropertyProducers.length > 0) {
            ...
            try {
                for (var _f = __values(this._extensionEventPropertyProducers.slice()), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var producer = _g.value;
                    try {
            ...
            properties = __assign(__assign({}, dynamicProperties), (properties !== null && properties !== void 0 ? properties : {}));
        }
        ...
        var url = (_e = options === null || options === void 0 ? void 0 : options._url) !== null && _e !== void 0 ? _e : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint);
    ...
    PostHog.prototype.calculateEventProperties = function (eventName, eventProperties, timestamp, uuid, readOnly) {
        ...
        properties = (0, general_utils_1.extend)({}, infoProperties, persistenceProperties, sessionPersistenceProperties, properties);
    ...
    PostHog.prototype._reset = function (reset_device_id, isConsentTransition) {
        var _a, _b;
