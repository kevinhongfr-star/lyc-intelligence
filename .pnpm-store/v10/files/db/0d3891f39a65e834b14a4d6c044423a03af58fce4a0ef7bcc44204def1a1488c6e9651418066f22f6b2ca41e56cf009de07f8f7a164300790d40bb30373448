...
exports.buildNetworkRequestOptions = exports.isInitialMaskFallback = exports.defaultNetworkOptions = exports.MAX_PAYLOAD_SIZE_BYTES = void 0;
...
var redactDeniedHeaders = function (headers) {
    if (!(0, core_1.isNullish)(headers)) {
        (0, general_utils_1.each)(Object.keys(headers), function (header) {
...
function scrubPayload(payload, label) {
    ...
    (0, general_utils_1.each)(PAYLOAD_CONTENT_DENY_LIST, function (text) {
...
var initialMaskFallbackRequests = new WeakSet();
var isInitialMaskFallback = function (request) {
    return !!request && initialMaskFallbackRequests.has(request);
};
exports.isInitialMaskFallback = isInitialMaskFallback;
/**
...
var buildNetworkRequestOptions = function (instanceConfig, remoteNetworkOptions) {
    ...
    config.maskRequestFn = (0, core_1.isFunction)(instanceConfig.session_recording.maskCapturedNetworkRequestFn)
        ? function (data) {
            ...
            var requiredInitialMetadata = cleanedRequest.isInitial
                ? {
                    name: '',
                ...
                : undefined;
            var maskedRequest = (_b = (_a = instanceConfig.session_recording).maskCapturedNetworkRequestFn) === null || _b === void 0 ? void 0 : _b.call(_a, cleanedRequest);
            ...
            if ((0, core_1.isNullish)(maskedRequest) && requiredInitialMetadata) {
                initialMaskFallbackRequests.add(requiredInitialMetadata);
                return requiredInitialMetadata;
            }
            return maskedRequest !== null && maskedRequest !== void 0 ? maskedRequest : undefined;
        }
