...
globals_1.assignableWindow.__PosthogExtensions__.rrweb = {
    ...
    getLastSnapshotCost: rrweb_record_1.getLastSnapshotCost,
    getMutationCost: rrweb_record_1.getMutationCost,
    resetSnapshotCostState: rrweb_record_1.resetSnapshotCostState,
};
globals_1.assignableWindow.__PosthogExtensions__.initSessionRecording = function (ph, documentWasEverVisible) {
    return new lazy_loaded_session_recorder_1.LazyLoadedSessionRecording(ph, documentWasEverVisible);
};
