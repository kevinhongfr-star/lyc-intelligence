...
import { DeadClicksAutoCaptureConfig } from '@posthog/types';
...
declare class LazyLoadedDeadClicksAutocapture implements LazyLoadedDeadClicksAutocaptureInterface {
    ...
    private _touchStart;
    private _deadSwipesCaptured;
    private _hasUnobservableSurfaces;
    private _surfacesCheckedAt;
    private _config;
    private _onCapture;
    ...
    private _onTouchEnd;
    private _pageHasUnobservableSurfaces;
    private _ignore;
    private _ignoreCommon;
    private _ignoreClick;
    private _checkClicks;
    private _captureDeadClick;
}

export { LazyLoadedDeadClicksAutocapture as default };
