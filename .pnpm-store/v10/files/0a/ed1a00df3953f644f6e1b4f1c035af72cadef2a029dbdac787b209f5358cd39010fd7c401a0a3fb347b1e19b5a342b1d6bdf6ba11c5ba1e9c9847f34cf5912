...
var SessionRecording = /** @class */ (function () {
    ...
    SessionRecording.prototype.dispose = function () {
        var _a;
        this._sessionRecordingDisposed = true;
        (_a = globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.removeEventListener) === null || _a === void 0 ? void 0 : _a.call(globals_1.document, 'visibilitychange', this._onVisibilityChange);
        this.stopRecording();
    };
