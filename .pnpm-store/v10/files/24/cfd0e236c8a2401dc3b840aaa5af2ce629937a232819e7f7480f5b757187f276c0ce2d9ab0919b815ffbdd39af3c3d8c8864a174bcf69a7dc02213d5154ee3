...
var PostHogLogs = /** @class */ (function () {
    ...
    PostHogLogs.prototype.onRemoteConfig = function (result) {
        ...
        var logCapture = (_a = result.config.logs) === null || _a === void 0 ? void 0 : _a.captureConsoleLogs;
