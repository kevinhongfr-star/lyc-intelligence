          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-bg-secondary border border-border text-sm"
              >
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full h-20 px-3 py-2 bg-bg-secondary border border-border text-sm resize-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-40 px-3 py-2 bg-bg-secondary border border-border text-sm resize-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-32 px-3 py-2 bg-bg-secondary border border-border text-sm resize-none"
              />
            </div>
          </CardContent>
        </Card>
