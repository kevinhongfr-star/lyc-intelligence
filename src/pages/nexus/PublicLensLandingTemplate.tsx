...
const LENS_DATA: Record<string, LensSEOContent> = {
  prism: {
    ...
    sampleInsight: 'Your narrative consistency scores in the 72nd percentile, but your Visibility lands at the 28th — meaning the quality of what you communicate is high, but too few people are hearing it. The single highest-leverage move for your brand is not refining your message, but multiplying its reach.',
    dimensionTeaser: [
  ...
  cpi: {
    ...
    whatItMeasures: [
      ...
      'The index uses a weighted scoring model calibrated against 200+ foreign firms operating in China across professional services, industrials, consumer, and tech. Scores are benchmarked by sector so you understand your position relative to peers, not against an abstract absolute.',
    ...
    howItWorks: [
      ...
      { num: '2', title: 'Weighted scoring with sector benchmarks', body: 'Responses are scored against the CPI calibration dataset. Your raw score is normalized to a 0–100 index, then compared against the sector peer band so you know whether a 62 is strong, average, or weak for your industry.' },
    ...
    whatYouGet: [
      ...
      'Four-dimension breakdown with sub-scores, gap flags, and calibration notes',
    ...
    sampleInsight: 'Your entity and regulatory footprint scores 71 — well above the sector median of 53 — but your Localized Value Proposition lands at 34, making it the binding constraint. The market sees a compliant foreign firm, not a firm that understands Chinese customers. Re-architecting three core service lines for onshore context will move your overall index further than adding two more cities or a second WFOE.',
    dimensionTeaser: [
  ...
  leap: {
    ...
    whatItMeasures: [
      ...
      'LEAP is calibrated against a dataset of 450+ executives in PE-backed, founder-led, and large-cap organizations. Different archetypes score differently by context; what constitutes "agile" for a Series B founder is not the same as for a Fortune 500 SVP.',
    ],
    howItWorks: [
  ...
  impact: {
    ...
    whatItMeasures: [
      ...
      'IMPACT is benchmarked against a senior-executive sample. What reads as "strong" for an individual contributor is often the middle of the distribution at partner / MD / board level. The readout is calibrated to the room you actually operate in, not the one you came from.',
    ],
    howItWorks: [
      ...
      { num: '2', title: 'Five-dimension scoring with calibration', body: 'Each dimension produces a raw score, then calibrated percentiles against the senior-executive reference sample. Calibration adjusts for role level, industry, and typical meeting size so comparisons are meaningful.' },
    ...
    whatYouGet: [
      'Five-dimension IMPACT profile with calibrated percentiles and written interpretation',
      ...
      'Three high-leverage micro-practices for the next 90 days, each testable in a single meeting',
  ...
  spark: {
    ...
    whatItMeasures: [
      ...
      'SPARK is calibrated across 300+ organizations from pre-Series-B to F500, with sector-specific bands. Innovation readiness means very different things for a semiconductor firm than for a consumer brand; the readout accounts for this.',
    ],
    howItWorks: [
    ...
    whatYouGet: [
      'Four-pillar SPARK profile with calibrated scores and interpretation',
  ...
  bridge: {
    ...
    whatItMeasures: [
      'BRIDGE measures four dimensions of cross-cultural effectiveness: Contextual Frame Switching, Hierarchy & Form Calibration, Communication Style Adaptation, and Trust-Building Across Thresholds. The profile describes not just awareness but demonstrated behavioral flexibility.',
    ...
    howItWorks: [
      ...
      { num: '4', title: 'Readout with context-specific calibration cards', body: 'You receive the dimension profile, your cultural gap analysis, the costliest-misstep diagnosis, and a set of calibration cards — one for each of your primary operating contexts — with concrete pre-meeting prompts and in-meeting heuristics.' },
    ],
    whatYouGet: [
      ...
      'A set of calibration cards with pre-meeting and in-meeting prompts for each context',
    ...
    dimensionTeaser: [
      ...
      { name: 'Hierarchy & Form Calibration', description: 'How appropriately you adjust your deference, directness, and protocol by context.' },
    ...
    whoItsFor: [
      ...
      'Professionals relocating for an international assignment who want a concrete pre-departure calibration beyond generic country briefings',
      'Global account managers and business development leads whose hit rate varies dramatically by region, suggesting a cultural calibration issue',
    ],
    cta: 'Start this lens',
  },
  mosaic: {
    ...
    tagline: 'Map the real political and relational architecture of your team — beyond the org chart.',
    whatItMeasures: [
  ...
  drive: {
    ...
    pillar: 'Executive Performance',
    tagline: 'A precise map of what actually drives you — and how your decision architecture shapes every outcome.',
    whatItMeasures: [
      'DRIVE combines two frameworks: a six-factor motivation profile derived from self-determination theory and regulatory focus, and a four-quadrant decision style model. The result is a profile that explains both why you choose what you choose, and how you go about choosing it.',
    ...
    howItWorks: [
      ...
      { num: '4', title: 'Readout with a career-alignment + decision-calibration plan', body: 'You receive both profiles, the interaction diagnosis, a current-role alignment check (how well your role feeds your dominant motivators), a decision-calibration plan with specific de-biasing prompts, and a set of career architecture questions to work through with a mentor or coach.' },
    ],
    whatYouGet: [
  ...
  quest: {
    ...
    whatItMeasures: [
      'QUEST measures four dimensions of personal narrative: Origin Story Coherence, Arc Definition & Tension, Audience Resonance Calibration, and Value / Mission Integration. Together they describe whether the story you tell about yourself does the work you need it to do — for hiring, fundraising, promotion, or leadership.',
    ...
    dimensionTeaser: [
      ...
      { name: 'Audience Resonance Calibration', description: 'How well you tailor story specificity, vulnerability, and jargon to the audience you are speaking to.' },
    ],
    whoItsFor: [
  ...
  coach: {
    ...
    whatYouGet: [
      ...
      'A feedback-solicitation template set calibrated to your Source Calibration score — how to ask, from whom, and in what form',
    ],
  ...
  forge: {
    ...
    whatItMeasures: [
      ...
      'FORGE produces a transition phase classification (Founder-Operator, Founder-Architect, Founder-Institution-Builder) and identifies the specific transition task that is currently binding — the one thing you most need to stop doing, start delegating, or learn to do differently before the next financing or inflection point.',
    ],
    howItWorks: [
    ...
    whatYouGet: [
      ...
      'Five-dimension FORGE profile calibrated against the founder-CEO reference dataset',
    ...
    sampleInsight: 'You are transitioning from Founder-Operator to Founder-Architect — the phase shift between 40 and 140 people. Product Detachment Capacity is your highest dimension at 78; Structured Decision Delegation is your lowest at 22. The binding transition task is not letting go of product decisions — you have already done that — but building a delegated decision architecture so the organization is not coming back to you for 14 specific recurring decisions, each of which looks small in isolation but cumulatively consumes 32% of your time per our instrument\'s estimate. The roadmap: define those 14 decisions explicitly, assign each to a named owner with explicit scope, and review the assignment after 90 days, not before.',
    dimensionTeaser: [
