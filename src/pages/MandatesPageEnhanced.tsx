    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <select
          ...
          className="bg-bg-secondary border border-bg-tertiary text-sm text-text-primary px-3 py-2.5 min-h-[44px]"
        >
          ...
          <div className="flex items-center gap-2">
            {BULK_ACTIONS.map((action) => (
              <button
                ...
                disabled={updating}
                className="px-3 py-1.5 bg-white border border-accent/30 text-sm text-text-primary hover:bg-accent hover:text-white flex items-center gap-1 disabled:opacity-50"
              >
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-end gap-1">
                        <button
                          onClick={() => navigate(`/platform/mandates/${mandate.id}`)}
                          className="px-3 py-1.5 text-xs bg-accent/10 text-accent hover:bg-accent hover:text-white"
                        >
                          View
                        </button>
                        <button
                          onClick={() => navigate(`/platform/mandates/${mandate.id}/pipeline`)}
                          className="px-3 py-1.5 text-xs bg-bg-tertiary text-text-secondary hover:bg-bg-secondary"
                        >
                          Pipeline
                        </button>
                      </div>
