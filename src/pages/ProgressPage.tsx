    ...
    <div style={{ minHeight: '100vh', background: DS.bg }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
        ...
        {assessments.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 0', background: DS.card,  border: `1px solid ${DS.cardBorder}` }}>
              ...
              <>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px' }}>
                    <div style={{ textAlign: 'center', padding: '20px', background: DS.bg }}>
                ...
                {/* Dimension Breakdown */}
                <div style={{ background: DS.card, border: `1px solid ${DS.cardBorder}`,  padding: '24px', marginBottom: '24px' }}>
                    ...
                    {Object.entries(selectedAssessment.scores).map(([dim, score]) => {
                      ...
                      return (
                        <div key={dim}>
                          ...
                          <div style={{ height: '8px', background: DS.border,  overflow: 'hidden' }}>
                            <div style={{
                              height: '100%',
                              width: `${score}%`,
                              background: color,
                ...
                {previousAssessment && (
                  <div style={{ background: DS.card, border: `1px solid ${DS.cardBorder}`,  padding: '24px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
                      <div style={{ textAlign: 'center', padding: '16px', background: DS.bg }}>
