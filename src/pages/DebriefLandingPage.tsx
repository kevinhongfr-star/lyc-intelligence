...
const DEBRIEF_FAQ = [
  {
    ...
    a: '[Emily: FAQ A1 — placeholder. Answer describing what debrief sessions are, how they differ from assessments, and what outcomes participants can expect.]',
  },
  {
  ...
  },
  {
    ...
    a: '[Emily: FAQ A6 — placeholder. Description of the 90-minute Council-only flagship CPI session, including bundled CPI assessment, pipeline health review, and China leadership context delivered by certified CPI specialists.]',
  },
  {
  ...
  },
  {
    ...
    a: '[Emily: FAQ A9 — placeholder. Description of post-session deliverables: written action summary, prioritised next steps, any assessment reports bundled with the session, and follow-up booking options.]',
  },
  {
...
const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    ...
    body: '[Emily: Step 2 body — placeholder. Join a structured 1:1 video debrief. Your coach comes prepared with context from your profile and any relevant assessments. The session is recorded if you wish, with your consent.]',
  },
  {
    mono: '03 · Action Plan',
