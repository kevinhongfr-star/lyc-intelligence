  ...
  <div className="min-h-screen bg-white">
    <section className="py-20" style={{ backgroundColor: '#47556915' }}>
      <div className="mx-auto max-w-4xl px-6 text-center">
        <h1 className="mb-4 text-4xl font-bold text-gray-900">Executive Coaching Programme</h1>
        <p className="mb-6 text-lg text-gray-600">Personalized coaching for senior leaders</p>
        <a href="#enroll" className="inline-flex rounded-lg px-8 py-3 font-semibold text-white" style={{ backgroundColor: '#475569' }}>Enquire Now</a>
      </div>
    </section>
    <section className="mx-auto max-w-4xl px-6 py-12">
      <div className="prose prose-gray max-w-none">
        <p>Our bespoke coaching programme pairs you with an experienced coach for 6 months of 1:1 development. Informed by your diagnostic results and tailored to your specific leadership challenges.</p>
      </div>
