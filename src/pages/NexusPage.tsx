    ...
    <div className="flex flex-col h-[calc(100vh-120px)]">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-text-muted text-sm">Your LYC Intelligence assistant — ask about leadership transitions, career strategy, and executive positioning</p>
        </div>
        {messages.length > 0 && (
      ...
      <div className="flex gap-2 mt-3">
        <input
          ...
          placeholder="Ask Nexus about career positioning, leadership transitions..."
