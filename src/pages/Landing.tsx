...
export function Landing() {
  ...
  const services = [
    { icon: IconTrident, animClass: 'anim-trident', title: 'Match Analysis', desc: 'AI-powered JD-CV matching engine. Score candidates instantly against role requirements.', href: '/match', cta: 'Try Now' },
    ...
    { icon: IconCompass, animClass: 'anim-compass', title: 'NEXUS AI', desc: 'Executive advisory on career positioning, talent scoring, and leadership alignment. Framework-aware conversations.', href: '/nexus/chat', cta: 'Try Now' },
  ];
  ...
  return (
    <div style={{ minHeight: '100vh', background: DS.bg }}>
      ...
      <div className={`nav-mobile ${mobileOpen ? 'open' : ''}`}>
        ...
        <a href="/nexus/chat" onClick={() => setMobileOpen(false)} style={{ fontFamily: DS.bodyFont, fontSize: '15px', fontWeight: 600, color: DS.accent, border: 'none', borderBottom: '1px solid #E5E5E5' }}>Try NEXUS →</a>
        <a href="/login" onClick={() => setMobileOpen(false)} style={{ fontFamily: DS.bodyFont, fontSize: '15px', fontWeight: 600, color: DS.text, border: 'none', borderBottom: '1px solid #E5E5E5' }}>Platform</a>
      </div>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', minHeight: '85vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 3, maxWidth: '900px', margin: '0 auto', padding: '96px 32px 48px', textAlign: 'center' }}>
          ...
          {/* Primary CTA row: NEXUS chat + dual paths */}
          <div className="reveal reveal-delay-1" style={{ marginBottom: '28px' }}>
            <a
              href="/nexus/chat"
              className="cta-glow"
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '10px',
                padding: '16px 36px', background: '#C108AB', color: '#FFF',
                fontFamily: DS.bodyFont, fontSize: '14px', fontWeight: 700,
      ...
      <div className="reveal" style={{ position: 'relative', overflow: 'hidden', padding: '80px 32px', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/nexus/chat" className="cta-glow" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 28px', background: '#C108AB', color: '#FFFFFF', borderRadius: '0px', fontFamily: DS.bodyFont, fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.2em', textDecoration: 'none', transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)' }}>
              Try NEXUS <ArrowRight style={{ width: 14, height: 14 }} />
            </a>
            <a href="/pricing" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 28px', border: '1px solid rgba(193,8,171,0.5)', color: '#C108AB', borderRadius: '0px', fontFamily: DS.bodyFont, fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.2em', textDecoration: 'none', transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)' }}>
              View Pricing
            </a>
          </div>
        </div>
