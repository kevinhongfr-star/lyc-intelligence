...
import { Brain, Globe, Award, ArrowRight, Shield, BarChart3, Star, MessageCircle, Menu, X } from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: DS.bg }}>
      ...
      <nav className="nav-sticky" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 32px', borderBottom: `1px solid ${DS.border}` }}>
        ...
        <div className="nav-links">
          ...
          <a href="/" style={{ fontFamily: DS.bodyFont, fontSize: '13px', color: DS.text, textDecoration: 'none', padding: '10px 20px', border: `1px solid ${DS.border}`, borderRadius: '6px', transition: 'all 0.2s cubic-bezier(0.4,0,0.2,1)', minHeight: '44px', display: 'flex', alignItems: 'center' }}>Sign In</a>
        </div>
      ...
      <div className={`nav-mobile ${mobileOpen ? 'open' : ''}`}>
        ...
        <a href="/" onClick={() => setMobileOpen(false)} style={{ fontFamily: DS.bodyFont, fontSize: '15px', fontWeight: 600, color: DS.accent, border: 'none', borderBottom: '1px solid #E5E5E5' }}>Sign In</a>
      </div>
      ...
      <div className="hero-padding section-padding" style={{ maxWidth: '900px', margin: '0 auto', padding: '96px 32px 60px', textAlign: 'center' }}>
        ...
        <div className="cta-row" style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/assessment" className="btn-hover" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 28px', background: DS.accent, color: '#FFF', borderRadius: '8px', fontFamily: DS.bodyFont, fontSize: '15px', fontWeight: 600, textDecoration: 'none', minHeight: '44px', transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)' }}>
            Free Assessment <ArrowRight style={{ width: 16, height: 16 }} />
          </a>
          <a href="/nexus" className="btn-hover" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 28px', border: '1px solid #000000', color: '#000000', borderRadius: '8px', fontFamily: DS.bodyFont, fontSize: '15px', fontWeight: 500, textDecoration: 'none', minHeight: '44px', transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)' }}>
      ...
      {/* CTA */}
      <div className="reveal section-padding" style={{ maxWidth: '480px', margin: '0 auto', padding: '40px 32px 96px', textAlign: 'center' }}>
