...
const config: AssessmentFlowConfig = {
  ...
  intro: {
    ...
    body: 'You will answer 36 questions across four dimensions of strengths orientation: Adaptive Learning Orientation, Market Context Awareness, Development Agency, and Bilateral Relationship Quality. Your responses map to a 2×2 strengths matrix: Selling Acumen vs. System Leadership. Answer as you actually operate today — not as you intend to.',
    duration: '~12 minutes',
    expectations: [
      '36 questions across Adaptive Learning Orientation, Market Context Awareness, Development Agency, and Bilateral Relationship Quality',
