...
export function InstallPrompt({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end justify-center pointer-events-none">
      ...
      {/* Card */}
      <div className="relative bg-card shadow-2xl w-full max-w-md mx-4 mb-4 pointer-events-auto animate-slide-up">
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-primary text-white font-medium hover:bg-primary/90 transition-colors"
            >
  ...
  return (
    <div className="bg-primary/10 border-b border-primary/20">
      <div className="container mx-auto px-4 py-2 flex items-center justify-between gap-4">
        ...
        <button
          onClick={install}
          className="px-3 py-1.5 bg-primary text-white text-sm font-medium hover:bg-primary/90 transition-colors"
        >
          Install
        </button>
      </div>
