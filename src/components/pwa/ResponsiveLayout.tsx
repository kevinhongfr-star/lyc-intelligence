...
function PWAUpdateToast() {
  ...
  return (
    <div className="fixed bottom-20 lg:bottom-4 left-4 right-4 lg:left-auto lg:right-4 lg:w-96">
      <div className="bg-card border border-card-border shadow-lg p-4">
...
export function Card({
  ...
  return (
    <Component
      onClick={onClick}
      className={`bg-card border border-card-border p-4 ${
...
export function ListItem({
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full flex items-center gap-3 p-3 bg-card border border-card-border hover:bg-bg-alt active:scale-[0.99] transition-all text-left ${className}`}
    >
      {leftIcon && (
        <div className="w-10 h-10 bg-bg-alt flex items-center justify-center flex-shrink-0 text-text-muted">
          {leftIcon}
        </div>
      )}
      <div className="flex-1 min-w-0">
