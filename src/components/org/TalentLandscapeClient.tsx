...
export function TalentLandscapeClient({ mandateId, userRole }: TalentLandscapeClientProps) {
  ...
  if (loading) {
    return (
      <div className="bg-bg p-8 flex items-center justify-center">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-card p-4 border border-card-border">
            ...
            {/* Key insights */}
            <div className="bg-card p-6 border border-card-border">
              ...
              <div className="bg-card p-6 border border-card-border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {companiesWithOrgCharts.slice(0, 3).map(company => (
                    <div
                      key={company.id}
                      className="bg-bg-alt p-4 border border-border hover:border-accent/50 cursor-pointer transition-all"
                      onClick={() => {
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <select
                ...
                className="px-4 py-2 bg-bg border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-accent"
              >
