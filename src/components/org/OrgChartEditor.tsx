      ...
      <div className="select-none">
        ...
        >
          ...
          <button
            ...
            className="p-1 hover:bg-accent/10 text-text-muted hover:text-accent"
          >
          ...
          <button
            ...
            className="p-1 hover:bg-red-500/10 text-text-muted hover:text-red-500"
          >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-bg border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-accent"
            >
            ...
            <div className="flex items-center gap-2">
              {[1, 2, 3, 4, 5].map(level => (
                <button
                  ...
                  className={`w-10 h-10 border-2 flex items-center justify-center font-medium transition-all ${
    ...
    <div className="bg-bg">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex bg-bg-alt p-1">
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
          ...
          <div>
            {editingNode ? (
              ...
              <div className="bg-card border border-card-border p-8 text-center">
