...
const variants = { default: 'bg-bg-tertiary text-text-secondary', success: 'bg-tier-1Bg text-tier-1', warning: 'bg-tier-2Bg text-tier-2', danger: 'bg-red-500/15 text-red-400' };
