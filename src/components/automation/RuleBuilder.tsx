...
const textareaClassName = 'w-full px-3 py-2 bg-bg-tertiary border border-bg-hover text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent resize-y min-h-[60px]';
  ...
  return (
    <Card className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={onCancel} className="p-2 hover:bg-bg-tertiary transition-colors">
      ...
      {/* Trigger */}
      <div className="mb-6 p-4 bg-bg-secondary">
            ...
            {conditions.map((condition, index) => (
              <div key={index} className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-2 hover:bg-bg-tertiary transition-colors text-red-500"
                >
        ...
        {actions.length === 0 ? (
          ...
          <div className="space-y-4">
            {actions.map((action, index) => (
              <div key={index} className="p-3 bg-bg-base">
      ...
      <div className="mb-6">
        ...
        {showPreview && (
          <div className="mt-3 p-4 bg-accent/10">
