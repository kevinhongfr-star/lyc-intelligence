              ...
              <div key={ev.id} className="border-b border-bg-hover last:border-b-0">
                <div className="flex items-center gap-3 px-4 py-3 hover:bg-bg-secondary/30">
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs border border-bg-hover hover:bg-bg-secondary flex items-center gap-1"
                  >
                  ...
                  <div className="bg-bg-secondary/30 px-4 py-3 border-t border-bg-hover">
                    {scores[ev.id] ? (
                      <div className="space-y-2">
                        ...
                        {scores[ev.id].map((s) => (
                          <div key={s.id} className="border border-bg-hover p-3 bg-white">
                            <div className="flex items-center gap-2">
                              ...
                              {s.overridden_at && (
                                <span className="text-xs text-amber-700 bg-amber-50 border border-amber-200 px-1.5 py-0.5">
                                  OVERRIDDEN
                                </span>
                              )}
                            </div>
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 text-xs border border-bg-hover hover:bg-bg-secondary flex items-center gap-1"
                        >
...
function OverrideModal({ evaluationId, scores, onClose, onSaved }: {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
      <div className="bg-white max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 space-y-4">
        ...
        <div className="space-y-3">
          {scores.map((s) => {
            ...
            return (
              <div key={s.id} className="border border-bg-hover p-3">
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <input
                    ...
                    className="w-16 border border-bg-hover px-2 py-0.5 text-sm"
                  />
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full border border-bg-hover px-2 py-1.5 text-sm"
        ...
        <div className="flex justify-end gap-2">
          <button onClick={onClose} className="px-3 py-1.5 text-sm border border-bg-hover">
            Cancel
          </button>
          <button
            onClick={save}
            disabled={submitting || changed.length === 0 || reason.length < OVERRIDE_MIN_REASON_LENGTH}
            className="px-3 py-1.5 text-sm bg-accent text-white hover:bg-accent-light disabled:opacity-50 flex items-center gap-1"
          >
