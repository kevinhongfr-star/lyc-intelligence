      ...
      {!companyId ? (
        ...
        <>
          ...
          <div className="flex flex-wrap items-end gap-3">
            <div>
              ...
              <select
                ...
                className="border border-bg-hover px-2 py-1 text-sm bg-white"
              >
            ...
            <div className="ml-auto">
              <button
                ...
                className="px-3 py-1.5 text-sm bg-accent text-white hover:bg-accent-light flex items-center gap-1"
              >
          ...
          {filtered.length === 0 ? (
            ...
            <div className="border border-bg-hover overflow-x-auto">
...
function AddIndividualForm({ companyId, onAdded }: { companyId: string; onAdded: () => void }) {
  ...
  return (
    <form onSubmit={submit} className="border border-bg-hover p-4 bg-bg-secondary/30 space-y-3">
  ...
  return (
    <div>
      ...
      <input
        ...
        required={required}
        className="w-full border border-bg-hover px-2 py-1.5 text-sm bg-white"
      />
    </div>
  );
}
