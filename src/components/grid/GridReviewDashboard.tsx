              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-center">
                      ...
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5, 6, 7].map(i => {
                          ...
                          return (
                            <div key={i} className={`w-3 h-3 ${metric?.status === 'green' ? 'bg-green-500' : metric?.status === 'yellow' ? 'bg-yellow-500' : 'bg-red-500'}`} />
                          );
                        })}
                      </div>
                    </div>
                    ...
                    <button className="p-2 hover:bg-bg">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="p-4">
            ...
            <pre className="text-sm text-text-primary whitespace-pre-wrap bg-bg-alt p-4 max-h-[400px] overflow-y-auto">
            ...
            {qualityMetrics.alerts.length > 0 && (
              <div className="mt-4 space-y-2">
                {qualityMetrics.alerts.map((alert, i) => (
                  <div key={i} className={`flex items-center gap-2 p-2 ${alert.type === 'warning' ? 'bg-yellow-50' : 'bg-red-50'}`}>
