...
export function SignupPrompt({ messageCount, onSignUp, onContinueAsGuest }: SignupPromptProps) {
  ...
  if (showSignupForm) {
    return (
      <div className="bg-gradient-to-r from-accent to-purple-600 p-6 mb-4">
        <button
          ...
          <>
            ...
            <form onSubmit={handleSignupSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-white text-accent font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {loading ? (
                  <>
