              ...
              <div key={stage.stage} className="relative">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 relative">
                    <div
                      className={`h-10 transition-all duration-500 flex items-center justify-end pr-4 ${
                        isBottleneck
      ...
      <div className="px-6 py-4 bg-bg-alt border-t border-card-border">
        <div className="flex items-center gap-6 text-sm text-text-muted">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 bg-accent/30 border border-accent/30" />
            <span>Normal flow</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 bg-red-200 border-2 border-red-400" />
