...
const ALTERNATIVES_BY_DEPTH: Record<AssessmentDepth, SessionSlug[]> = {
  flagship:  ['cpi-deepdive-90', 'leadership-60', 'executive-45'],
  signature: ['leadership-60', 'executive-45', 'career-30'],
...
function getRationaleForDepth(depth: AssessmentDepth): string {
  switch (depth) {
    ...
    case 'signature':
      return 'NEXUS recommends a 60-minute leadership strategy session to translate your diagnostic insights into a structured roadmap with a senior leadership coach.';
    case 'standard':
      return 'NEXUS recommends a 45-minute executive session to translate your diagnostic insights into concrete next-step strategy with a certified coach.';
    case 'light':
    default:
