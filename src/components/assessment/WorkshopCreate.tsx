    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        ...
        <button
          ...
          className="px-6 py-3 bg-accent text-white font-medium hover:bg-accent/90"
        >
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-bg-secondary p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-white border border-bg-tertiary focus:outline-none focus:border-accent"
              >
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-bg-tertiary focus:outline-none focus:border-accent resize-none"
                rows={4}
              />
              <Button
            ...
            {participants.length > 0 && (
              <div>
                ...
                <div className="space-y-2">
                  {participants.map(p => (
                    <div key={p.id} className="flex items-center justify-between p-3 bg-white border border-bg-tertiary">
                      <div>
        ...
        {step === 'review' && (
          <div className="space-y-6">
            <div className="bg-white p-6 border border-bg-tertiary">
      ...
      {/* Error */}
      {error && (
        <div className="mt-6 bg-red-50 border border-red-200 p-4 text-red-700">
          {error}
        </div>
      )}
