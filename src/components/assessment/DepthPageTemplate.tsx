...
function WhatYouGetSection({ accent }: { accent: string }) {
  const bullets = [
    ...
    },
    {
      ...
      desc: '[Emily: upsell copy — placeholder. After your results, NEXUS can suggest a live debrief session with a certified coach if you want to turn the assessment into a concrete action plan. 30–90 minutes depending on depth.]',
      isUpsell: true,
    },
  ];
    ...
    <section data-depth-get style={{ background: DS.bg, padding: '96px 32px' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        <div>
          ...
          <p style={SECTION_LEAD}>
            [Emily: what you get lead paragraph — placeholder. Your assessment includes the PDF report,
