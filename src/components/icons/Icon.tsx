...
const makeSvg = (paths: React.ReactNode) => {
...
const paths = {
  ...
  'check-circle': <><circle cx="12" cy="12" r="10" /><polyline points="8 12 11 15 16 10" /></>,
  ...
  file: <><path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9l-7-7z" /><polyline points="13 2 13 9 20 9" /></>,
  ...
  'sort-asc': <><path d="M3 6h13M3 12h9M3 18h5" /><polyline points="17 8 21 4 25 8" /><line x1="21" y1="4" x2="21" y2="20" /></>,
  ...
  store: <><path d="M3 9l1-5h16l1 5" /><path d="M3 9v11a1 1 0 001 1h16a1 1 0 001-1V9" /><path d="M3 9h18" /><path d="M9 13h6" /></>,
  ...
  wallet: <><path d="M20 12V8H6a2 2 0 01-2-2c0-1.1.9-2 2-2h12v4" /><path d="M4 6v12c0 1.1.9 2 2 2h14v-4" /><path d="M18 12a2 2 0 000 4h4v-4h-4z" /></>,
  coins: <><line x1="8" y1="6" x2="21" y2="6" /><line x1="8" y1="12" x2="21" y2="12" /><line x1="8" y1="18" x2="21" y2="18" /><line x1="3" y1="6" x2="3.01" y2="6" /><line x1="3" y1="12" x2="3.01" y2="12" /><line x1="3" y1="18" x2="3.01" y2="18" /></>,
  'dollar-sign': <><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" /></>,
  percent: <><line x1="19" y1="5" x2="5" y2="19" /><circle cx="6.5" cy="6.5" r="2.5" /><circle cx="17.5" cy="17.5" r="2.5" /></>,
  receipt: <><path d="M4 2v20l3-2 3 2 3-2 3 2 3-2 3 2V2l-3 2-3-2-3 2-3-2-3 2z" /><line x1="8" y1="7" x2="16" y2="7" /><line x1="8" y1="11" x2="16" y2="11" /><line x1="8" y1="15" x2="12" y2="15" /></>,
  ...
  'mic-off': <><line x1="1" y1="1" x2="23" y2="23" /><path d="M9 9v3a3 3 0 005.12 2.12M15 9.34V4a3 3 0 00-5.94-.6" /><path d="M17 16.95A7 7 0 015 12v-2m14 0v2a7 7 0 01-.11 1.23" /><line x1="12" y1="19" x2="12" y2="23" /><line x1="8" y1="23" x2="16" y2="23" /></>,
  ...
  bold: <path d="M6 4h8a4 4 0 014 4 4 4 0 01-4 4H6z M6 12h9a4 4 0 014 4 4 4 0 01-4 4H6z" />,
  ...
  pilcrow: <><line x1="13" y1="4" x2="13" y2="20" /><path d="M13 16a4 4 0 01-4-4V8h6" /><path d="M13 8a4 4 0 014 4" /></>,
  ...
  cursor: <path d="M4 4l7 18 2.5-7.5L21 12 4 4z" />,
  'pointer': <><path d="M3 3l7.07 16.97 2.51-7.39 7.39-2.51L3 3z" /><path d="M13 13l6 6" /></>,
  'accessibility': <><circle cx="12" cy="12" r="10" /><circle cx="12" cy="7" r="1" /><path d="M7 11h10" /><path d="M12 11v4l-2 7" /><path d="M12 15l2 7" /></>,
  ...
  plug: <><path d="M9 2v6" /><path d="M15 2v6" /><path d="M6 8h12v4a6 6 0 11-12 0V8z" /><path d="M12 18v4" /></>,
  usb: <><circle cx="10" cy="7" r="1" /><path d="M10 8v6l4 4v4" /><path d="M14 14l4-4V6l-4-4" /><circle cx="14" cy="6" r="1" /></>,
  ...
  'hard-hat': <><path d="M4 15v-3a8 8 0 0116 0v3" /><rect x="2" y="15" width="20" height="4" rx="1" /></>,
  construction: <><path d="M2 20h20" /><path d="M4 20V10l8-6 8 6v10" /><path d="M9 20v-6h6v6" /></>,
  'person-standing': <><circle cx="12" cy="5" r="2" /><path d="M12 7v8" /><path d="M8 11l4-2 4 2" /><path d="M10 15l-2 7" /><path d="M14 15l2 7" /></>,
  'person-sitting': <><circle cx="12" cy="5" r="2" /><path d="M8 21v-5h8v5" /><path d="M10 16l-2-6h8l-2 6" /></>,
  id: <><rect x="3" y="4" width="18" height="16" rx="2" /><circle cx="9" cy="10" r="2" /><path d="M15 8h2" /><path d="M15 12h2" /><path d="M7 16h10" /></>,
  badge: <><path d="M12 2l3 7h7l-5.5 4.5L18 21l-6-4-6 4 1.5-7.5L2 9h7z" /></>,
  ribbon: <><path d="M4 2v16l4-3 4 3 4-3 4 3V2H4z" /><line x1="4" y1="6" x2="20" y2="6" /><line x1="4" y1="10" x2="20" y2="10" /></>,
  ...
  school: <><path d="M3 21V9l9-6 9 6v12" /><path d="M9 22V12h6v10" /></>,
  library: <><rect x="3" y="3" width="4" height="18" /><rect x="10" y="3" width="4" height="18" /><path d="M18 3l3 1-3 17-3-1z" /></>,
...
export const Icon = Object.fromEntries(
  Object.entries(paths).map(([name, nodes]) => [name, makeSvg(nodes)])
) as Record<string, ReturnType<typeof makeSvg>>;

export type IconNameType = keyof typeof paths;

export function createIcon(name: string) {
  return Icon[name] || Icon['info'];
}
