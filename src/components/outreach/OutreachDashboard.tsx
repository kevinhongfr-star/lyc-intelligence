  ...
  return (
    <div className="bg-bg-secondary border border-border p-4">
      <div className="flex items-start justify-between">
        ...
        <div className={`p-2 bg-bg-tertiary ${color}`}>
      ...
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="bg-bg-secondary border border-border px-3 py-2 text-sm text-text-primary min-h-[44px]"
          >
              ...
              return (
                <div key={d.date} className="flex-1 flex flex-col items-center gap-1 min-w-0">
                  <div className="w-full flex flex-col justify-end h-24">
                    <div
                      className={`w-full transition-all ${isToday ? 'bg-accent' : 'bg-accent/60'}`}
