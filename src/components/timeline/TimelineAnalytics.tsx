        ...
        <div className="space-y-4">
          {stageAnalytics.map((stage) => {
            ...
            return (
              <div
                key={stage.stage}
                className="cursor-pointer hover:bg-bg-alt p-3 -mx-3 transition-colors"
              ...
              >
                ...
                <div className="relative">
                  {/* Min-Max Range */}
                  <div
                    className="absolute h-3 bg-gray-200"
                    style={{ width: `${maxWidth}%`, left: `${minWidth}%` }}
                  />
                  {/* Average Bar */}
                  <div
                    className="relative h-3 bg-gradient-to-r from-accent to-accent/70"
                    style={{ width: `${avgWidth}%` }}
                  >
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 bg-accent border-2 border-white" />
                  </div>
                </div>
              </div>
            );
          ...
          {consultantAnalytics
            ...
            .map((consultant, idx) => (
              <div
                ...
                className="flex items-center gap-4 p-4 bg-bg-alt"
              >
                <div className="w-8 h-8 bg-accent/10 flex items-center justify-center text-accent font-semibold">
                  {idx + 1}
                </div>
