    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border overflow-hidden">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          ...
          {outlookAccount && outlookAccount.is_active ? (
            ...
            <span className="px-2.5 py-1 text-xs font-medium bg-bg-alt text-text-muted">
              Not connected
            </span>
          )}
        </div>
        ...
        {outlookAccount && outlookAccount.is_active ? (
          <div className="p-6 space-y-4">
            ...
            {outlookAccount.sync_status === 'auth_expired' && (
              <div className="bg-amber-50 border border-amber-200 text-amber-700 px-4 py-2 text-sm">
      ...
      <div className="bg-card border border-border overflow-hidden">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          ...
          <span className="px-2.5 py-1 text-xs font-medium bg-emerald-50 text-emerald-700">
            Always Available
          </span>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-bg-base border border-border">
      ...
      {/* Security Notice */}
      <div className="bg-bg-alt border border-border p-4">
