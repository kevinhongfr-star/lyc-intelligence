      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div ref={searchRef} className="relative">
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div className="absolute z-10 w-full mt-1 bg-bg-base border border-bg-hover shadow-lg max-h-48 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full mt-1 px-3 py-2 bg-bg-tertiary border border-bg-hover text-sm text-text-primary focus:outline-none focus:border-accent"
            >
