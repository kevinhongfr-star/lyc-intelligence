    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
            ...
            <div key={check.key} className="border p-3">
              ...
              <div className="flex gap-2 mt-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1 px-3 py-2 border transition-all ${
            ...
            <div className="grid grid-cols-2 gap-2">
              {CHANNEL_OPTIONS.map((option) => (
                <button
                  ...
                  className={`flex items-center justify-center gap-2 px-3 py-2 border transition-all ${
          ...
          {contactChannel === 'NONE' && (
            <div className="p-3 bg-yellow-100 border border-yellow-300 text-yellow-700">
