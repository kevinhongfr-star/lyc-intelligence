    ...
    return (
      <Card className="p-6">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="bg-bg-alt p-4 w-full text-left">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-3 py-2 border bg-bg-base text-text-primary ${
        ...
        <div>
          ...
          <select
            ...
            className={`w-full px-3 py-2 border bg-bg-base text-text-primary ${
