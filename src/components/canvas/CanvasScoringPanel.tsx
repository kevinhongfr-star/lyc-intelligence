...
export function CanvasScoringPanel({ scorecardId, contactId, mandateId, onGenerate }: CanvasScoringPanelProps) {
  ...
  if (loading) return <div className="flex items-center justify-center py-20"><div className="animate-spin h-8 w-8 border-b-2 border-blue-600"></div></div>;
  ...
  return (
    <div className="flex gap-6 h-full">
      ...
      <div className="w-1/4 bg-gray-50 p-6 flex flex-col items-center justify-center">
