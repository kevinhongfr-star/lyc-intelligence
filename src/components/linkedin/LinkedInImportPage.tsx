...
export function LinkedInImportPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-medium ${config.bg} ${config.text}`}>
  ...
  const getActionBadge = (action?: string) => {
    ...
    return (
      <span className={`px-2 py-0.5 text-xs font-medium ${config.bg}`}>
        {config.label}
      </span>
    );
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      {/* Tabs */}
      <div className="flex gap-1 mb-6 bg-bg-alt p-1">
        {tabs.map(tab => {
          const Icon = tab.icon;
          return (
            <button
                              ...
                              {expandedItems.has(item.id) && (
                                <div className="px-4 pb-3 border-t border-border bg-bg-base/50">
                                  <div className="pt-3 space-y-2 text-xs">
                                    ...
                                    {item.deepseek_error && (
                                      <div className="text-red-600 bg-red-50 px-2 py-1">
...
function URLImportTab({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div className="bg-card border border-border p-6">
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-2 text-sm mb-4">
          {error}
        </div>
      )}

      {result && (
        <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 text-sm mb-4">
      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            className="w-full h-40 px-3 py-2 bg-bg-base border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-primary font-mono text-sm"
...
function CSVImportTab({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <div className="bg-card border border-border p-6">
      <div className="flex items-start gap-3 mb-4">
        <div className="w-10 h-10 bg-purple-50 flex items-center justify-center flex-shrink-0">
      ...
      <div className="space-y-4">
        <div className="border-2 border-dashed border-border p-8 text-center hover:border-primary/50 transition-colors">
          ...
          <label className="inline-flex items-center gap-2 px-4 py-2 bg-bg-alt hover:bg-bg-base cursor-pointer text-sm font-medium text-text-primary border border-border">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-40 px-3 py-2 bg-bg-base border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-primary font-mono text-xs"
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 bg-bg-base border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-primary text-sm"
          >
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-bg-base border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-64 px-3 py-2 bg-bg-base border border-border text-text-primary focus:outline-none focus:ring-2 focus:ring-primary font-mono text-xs"
