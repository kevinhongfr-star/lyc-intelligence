  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-card p-5 border border-card-border">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-card border-r border-border flex flex-col transition-all duration-300`}>
        ...
        <div className="p-3 border-t border-border">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 text-text-muted hover:bg-bg-alt transition-colors relative"
          >
            <Bell className="w-5 h-5" />
            {sidebarOpen && <span className="flex-1 text-left font-medium">Notifications</span>}
            {unreadCount > 0 && (
              <span className="absolute right-2 top-1 w-5 h-5 bg-red-500 text-white text-xs flex items-center justify-center">
        ...
        <div className="p-3 border-t border-border">
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-3 py-2.5 text-text-muted hover:bg-bg-alt transition-colors"
          >
