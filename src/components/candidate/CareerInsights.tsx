...
export function CareerInsights({ insights }: CareerInsightsProps) {
  ...
  const renderInsightCard = (insight: CareerInsight) => (
    <div 
      key={insight.id}
      className="bg-card border border-card-border p-5 hover:border-accent/50 transition-all"
    >
      ...
      {insight.relevance_score && (
        <div className="mt-4 pt-4 border-t border-border">
          ...
          <div className="h-1.5 bg-bg-alt mt-1 overflow-hidden">
            <div 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-card-border p-5">
        ...
        <div className="mt-4 p-4 bg-accent/5 border border-accent/20">
