...
export function LinkedInImportModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-4xl bg-bg-primary shadow-2xl overflow-hidden border border-border flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          ...
          <button
            onClick={handleClose}
            className="p-2 text-text-muted hover:bg-slate-100 hover:text-text-primary"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
              ...
              <React.Fragment key={s}>
                ...
                >
                  {s < step ? <Check className="w-4 h-4" /> : (
                    <span className="w-5 h-5 bg-white/20 flex items-center justify-center text-xs">
                      {s}
                    </span>
                  )}
                  {s === 1 && 'Upload'}
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                {fileName ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-14 h-14 bg-accent/10 text-accent flex items-center justify-center">
              ...
              <div className="text-xs text-text-muted bg-slate-50 p-3 border border-border/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={col} className="px-2 py-1 bg-white border border-border/60">
                      {col}
                    </span>
                  ))}
                </div>
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] gap-3 items-center bg-bg-secondary px-4 py-3 text-xs font-semibold text-text-primary border border-border">
                <div>CSV Column</div>
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                {headers.map((header, idx) => {
                  ...
                  return (
                    <div
                      key={header}
                      className={`grid grid-cols-[1fr_auto_1fr] gap-3 items-center px-4 py-3 border transition-colors ${
                        isUnmapped
                    ...
                    >
                      ...
                      <div>
                        <select
                          ...
                          className="w-full px-3 py-2 text-sm bg-white border border-border focus:ring-2 focus:ring-accent/30 focus:border-accent"
                        >
          ...
          {step === 4 && importResult && !importing && (
            <div className="space-y-6">
              ...
              {importResult.pipeline_created > 0 && (
                <div className="p-4 bg-accent/5 border border-accent/30 flex items-center gap-3">
              ...
              {importResult.errorList.length > 0 && (
                <div>
                  ...
                  <div className="max-h-48 overflow-y-auto bg-red-50 border border-red-200 divide-y divide-red-100">
              ...
              <div className="flex items-center justify-center pt-2">
                <button
                  onClick={handleClose}
                  className="px-6 py-2.5 bg-accent text-white hover:bg-accent-hover font-medium text-sm min-h-[44px]"
                >
                  Done
                </button>
              </div>
        ...
        {step !== 4 && (
          <div className="px-6 py-4 border-t border-border flex items-center justify-between">
            <button
              ...
              className="px-4 py-2 text-sm text-text-primary border border-border hover:bg-slate-50 min-h-[44px]"
            >
              {step === 1 ? 'Cancel' : 'Back'}
            </button>
            ...
            <div className="flex items-center gap-2">
              {importing && (
                <span className="flex items-center gap-2 text-sm text-text-muted">
                  <span className="inline-block w-4 h-4 border-2 border-slate-300 border-t-accent animate-spin" />
                  {importProgress}
                </span>
              )}
              ...
              {step === 1 && (
                <button
                  ...
                  onClick={() => setStep(2)}
                  className="px-5 py-2 text-sm text-white bg-accent hover:bg-accent-hover disabled:bg-slate-300 disabled:cursor-not-allowed min-h-[44px]"
                >
                  Next: Map columns
                </button>
              )}
              ...
              {step === 3 && !importing && (
                <button
                  ...
                  className="px-5 py-2 text-sm text-white bg-accent hover:bg-accent-hover disabled:bg-slate-300 disabled:cursor-not-allowed min-h-[44px] font-medium"
                >
