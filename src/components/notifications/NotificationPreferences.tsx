  ...
  return (
    <Card className="p-6">
      <div className="space-y-6">
                    ...
                    <div className="flex justify-center gap-1">
                      {DELIVERY_OPTIONS.map(option => (
                        <button
                          ...
                          className={`flex items-center justify-center gap-1 px-3 py-1.5 text-sm font-medium transition-colors ${
        ...
        {/* Legend */}
        <div className="flex flex-wrap items-center gap-4 p-4 bg-bg-alt">
