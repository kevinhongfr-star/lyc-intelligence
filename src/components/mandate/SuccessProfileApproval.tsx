              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.required_experience_years && (
                    <span className="px-2 py-1 bg-blue-50 text-blue-700 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.required_industries?.map((ind, i) => (
                    <span key={i} className="px-2 py-1 bg-purple-50 text-purple-700 text-sm">
                      {ind}
                    </span>
                  ))}
                  {profile.required_geographies?.map((geo, i) => (
                    <span key={i} className="px-2 py-1 bg-green-50 text-green-700 text-sm">
                      {geo}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.target_disc_profile && (
                    <span className="px-2 py-1 bg-orange-50 text-orange-700 text-sm">
                      DISC: {profile.target_disc_profile}
                    </span>
                  )}
                  {profile.personality_indicators?.slice(0, 3).map((p, i) => (
                    <span key={i} className="px-2 py-1 bg-orange-50 text-orange-700 text-sm">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {profile.certifications?.slice(0, 3).map((cert, i) => (
                    <span key={i} className="px-2 py-1 bg-pink-50 text-pink-700 text-sm">
                      {cert}
                    </span>
                  ))}
                </div>
        ...
        <div className="space-y-4">
          {action === 'approve' && (
            <div className="bg-white p-4 border border-emerald-200">
              ...
              <textarea
                className="w-full mt-2 border border-slate-200 px-3 py-2 text-sm min-h-[80px]"
