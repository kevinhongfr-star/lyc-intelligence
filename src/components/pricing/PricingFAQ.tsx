...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    category: 'Upgrades',
    question: '[Emily: What happens when I use my complimentary Explorer diagnostics?]',
  ...
  {
    category: 'CPI Access',
    question: '[Emily: How do I access the CPI diagnostic?]',
    answer: '[Emily: CPI answer — CPI is the flagship 5-mile diagnostic (China Leadership Pipeline Index), requires Council tier. Mapped to tier matrix §cpi.]',
  },
  // ── Document Upload ──
  {
    category: 'Documents',
