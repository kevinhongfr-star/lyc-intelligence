...
function dimDescription(instrument: string, dimId: string, dimName: string): string {
  ...
  const map: Record<string, string> = {
    "CPI:D1": "How clearly you articulate long-term strategic direction, connect initiatives to organizational purpose, and make trade-offs aligned with a coherent strategic framework.",
    "CPI:D2": "Your ability to operate effectively across cultural contexts, adapt communication and decision-making styles to diverse markets, and navigate cross-border stakeholder dynamics.",
    ...
    "PRISM:D3": "How consistently your professional identity shows up across platforms, interactions, and contexts. Identity consistency reduces friction when stakeholders encounter you in different settings.",
    ...
    "SPARK:D1": "How deeply and consistently AI tools are part of your personal executive workflow. Individual AI Adoption Readiness gauges whether you are leveraging AI in your own day-to-day decision-making and output.",
    ...
    "QUEST:D2": "How consistently you convert strategy into results through organisational design, accountability architecture, and performance visibility. Execution Excellence measures delivery discipline at scale.",
    ...
    "QUEST:D4": "How effectively you architect teams, develop succession, and make high-stakes people decisions. People Leadership measures whether you build capability, not just deliver through others.",
    "QUEST:D5": "Your tolerance for ambiguity, ability to pivot when context changes, and track record of adapting during disruption. Adaptive Capacity gauges how you perform when the playbook stops working.",
    "QUEST:D6": "Whether you have the decision architecture, data governance awareness, and AI ethics oversight required for board-level AI accountability. AI Readiness calibrates your governance fluency.",
    ...
    "IMPACT:D3": "How well you read stakeholder ecosystems, navigate boardroom dynamics, and build relationships that create influence beyond formal authority. Stakeholder Intelligence calibrates relational governance capability.",
    ...
    "FORGE:D2": "How aware you are of the three structural forces shaping bilateral operating contexts: AI capability asymmetry, tempo gap acceleration, and governance & succession decisions. Three Forces Awareness calibrates system-level thinking.",
    ...
    "FORGE:D4": "How effectively you lead in bilateral contexts where authority is ambiguous, counterpart capability varies, and multiple concurrent leadership challenges operate simultaneously. Bilateral Context Navigation gauges operating leadership in partnership environments.",
    ...
    "DRIVE:D3": "How congruent your personal values, sense of purpose, and ethical framework are with your current role and organisation. Values Alignment measures whether you can sustain commitment long-term.",
    "DRIVE:D4": "Your belief in your own capability to perform under pressure, adapt to challenges, and deliver in your specific role context. Confidence & Self-Efficacy calibrates whether you act when conditions are uncertain.",
    ...
    "COACH:D3": "The quality of trust you build in bilateral developmental relationships — your ability to hold counterparts accountable, sustain trust through difficulty, and re-engage after setbacks. Bilateral Developmental Relationship Quality calibrates trust depth.",
    "COACH:D4": "Whether you can maintain a coaching stance when the partnership is under performance pressure, authority is ambiguous, or structural constraints make coaching difficult. Coaching Under Bilateral Constraints gauges reliability when it matters most.",
    ...
    "BRIDGE:D2": "Your structured approach to mapping stakeholders, building informal relationships, navigating power structures, and managing government or political connections in APAC contexts.",
    ...
    "BRIDGE:D4": "Whether you can sustain performance and focus through extended periods of multi-directional pressure — from headquarters, local teams, political stakeholders, and crises. Pressure Resilience calibrates durability in the APAC mandate.",
    ...
    "MOSAIC:D1": "How well you understand and navigate institutional dynamics in cross-border partnerships — including contractual versus relational enforcement, AI adoption asymmetry between partners, and how bilateral institutional trust actually operates.",
    "MOSAIC:D2": "How quickly you can establish working trust in new cross-border contexts, adapt relationship-building for different institutional environments, and maintain relationship quality through disruptions.",
...
function buildArchetypeTraits(instrument: string, archetype: any): string[] {
  ...
  switch (instrument) {
    ...
    case "BRIDGE":
      ...
      if (archetype["#"]) traits.push(`Profile #${archetype["#"]}`);
      if (archetype.three_fires_correlation) traits.push(String(archetype.three_fires_correlation).slice(0, 60));
      break;
    case "MOSAIC":
      if (archetype.profile) traits.push(String(archetype.profile).slice(0, 70));
      if (archetype.organisational_impact) traits.push(`Org Impact: ${String(archetype.organisational_impact).slice(0, 60)}`);
