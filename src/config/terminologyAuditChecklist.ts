...
export const AUDIT_CHECKLIST: AuditItem[] = [
  ...
  },
  {
    ...
    correctForm: 'No tier names (platform layer handles upgrade direction)',
    commonError: '"Professional tier", "Executive tier", "Council tier" in responses',
  ...
  },
  {
    ...
    correctForm: 'INSTRUMENT_MILE_COST values (e.g. LEAP=3, SPARK=1, CPI=5)',
    commonError: 'Wrong mile cost stated in chat (e.g. "LEAP costs 2 miles")',
    acceptanceCriteria: 'Every mile cost stated in chat matches INSTRUMENT_MILE_COST exactly.',
  ...
  },
  {
    ...
    correctForm: 'Explorer, Starter, Professional, Executive, Council',
    commonError: '"Pro" (instead of Professional), "Basic", "Enterprise"',
    acceptanceCriteria: 'All tier cards use canonical display names from tiers.ts. "Professional" never "Pro".',
  ...
  },
  {
    ...
    correctForm: 'TIER_CTA_LABEL values (e.g. "Start Your Complimentary Baseline", "Go Professional")',
  ...
  },
  {
    ...
    correctForm: 'Canonical tier display names (Explorer, Starter, Professional, Executive, Council)',
    commonError: 'Raw tier_key ("explorer"), "Pro", "Enterprise"',
    acceptanceCriteria: 'Settings shows canonical display name via tierDisplayName() — never raw key or "Pro".',
...
export const CROSS_SURFACE_CHECKS: CrossSurfaceCheck[] = [
  ...
  },
  {
    ...
    correctForm: 'Explorer, Starter, Professional, Executive, Council',
    commonError: '"Pro" in pricing, "Professional" in settings; "Enterprise" in nav',
    surfaces: ['pricing_page', 'settings_account', 'onboarding_flow', 'landing_pages', 'email_templates', 'navigation_footer'],
    acceptanceCriteria: 'Canonical display names from tiers.ts used everywhere. "Pro" never user-facing. "Enterprise" never (collapsed into Council).',
    verifyMethod: 'Grep: "Pro tier|\\bPro\\b|Enterprise" across surface locations.',
    status: 'pending',
  },
  {
...
export const BANNED_WORD_PER_SURFACE: BannedWordSurfaceCheck[] = [
  ...
  },
  {
    ...
    enforcementNotes: '"assessment" is canonical — never "test"/"quiz"/"survey"/"questionnaire".',
  },
  {
    surface: 'email_templates',
