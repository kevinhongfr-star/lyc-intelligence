...
export const CROSS_BATCH_DEPENDENCIES: CrossBatchDependency[] = [
  ...
  },
  {
    ...
    delivers: [
      ...
      'NEXUS personas (Guide, Analyst, Architect, Steward)',
    ...
    requiredForFinalPass: true,
    status: 'complete',
    notes: 'Corrective pass applied: "Framework Integration" → "Model Integration", "Prompt Architecture" → "Prompt System Design".',
  },
  {
    batch: 'batch_2_corrective',
    delivers: [
      'Banned word remediation — "free" → "complimentary" across Ticket 2 surfaces',
      'Quality dimension rename — "Framework Integration" → "Model Integration"',
