...
if (ENABLE_PLATFORM) {
  try {
    AppLayout = require('@/components/layout/AppLayout').AppLayout;
    ConsultantDashboard = require('@/components/dashboard/ConsultantDashboard').ConsultantDashboard;
    MandatesPage = require('@/pages/MandatesPage').MandatesPage;
    CandidatesPage = require('@/pages/CandidatesPage').CandidatesPage;
    MandateDetailPage = require('@/pages/MandateDetailPage').MandateDetailPage;
    ...
    MetrixPage = require('@/pages/MetrixPage').MetrixPage;
    ScoringRunsPage = require('@/pages/ScoringRunsPage').ScoringRunsPage;
    LensExportPage = require('@/pages/LensExportPage').LensExportPage;
  } catch (e) {
    console.error('Failed to load platform components:', e);
  }
}
