...
## FOR ECHO (Marketing, Business, Training, Webinar, Podcast, Content Materials & Templates)
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/ECHO_BRIEF.md
...
- Comms Methodology: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/COMMS_METHODOLOGY.md

WHAT YOU OWN: Marketing, business development, training, webinars, podcasts, and all content materials & templates. You are the content engine that produces everything the other agents deploy. You don't publish — you produce. Carl publishes, Maria outreaches, Hans researches, Akira owns assessment diagnostics. You supply the materials.
...
- Day 3 (Aug 8): All core content templates (decks, one-pagers, email sequences)
- Aug 14: Webinar #1 full deliverable (deck + script + all promo copy)

WEBINAR TRACKER (parallel — this is your primary ownership):
...
## FOR VALENTINA (Website — End-to-End)
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/VALENTINA_BRIEF.md

READ FIRST:
- Brand Constitution: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CONSTITUTION.md
- Brand Checklist: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CHECKLIST.md

WHAT YOU OWN: The entire website — design, build, implementation, and go-live. You are not just design. You own the site end-to-end. ECHO writes the copy you drop in; Akira does not build the website (he owns diagnostics/assessments).
...
NEAREST DEADLINES:
- Day 1-2 (today): Information architecture + site map + hero + services page live on staging
- Day 3-4 (Aug 8-9): All core pages implemented
- Day 7 (Aug 12): WEBSITE GOES LIVE — this is the big one

WEBINAR TRACKER (parallel — CRITICAL PATH):
- Registration page lives on your website (deadline Aug 12)
- BLOCKED on Kevin's Teams webinar link for the actual registration form, but page structure and design can start now
- https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/WEBINAR_TRACKER.md
...
## FOR AKIRA (Diagnostics and Assessments)
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/AKIRA_BRIEF.md
...
NEAREST DEADLINES:
- Days 1-2 (today): Assessment inventory + functional naming proposal + diagnostic framework audit
- Day 3 (Aug 8): Assessment report template redesign (outcomes-first)
- Day 4-5 (Aug 9-10): CPI (China Leadership Pipeline Assessment) full diagnostic review
- Day 7 (Aug 12): CPI assessment live for webinar #1 — CRITICAL PATH

WEBINAR TRACKER (parallel — CRITICAL PATH):
- CPI assessment is the primary CTA for webinar #1
- Diagnostic flow, scoring, and report output must be locked and tested by Aug 12
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/JAMES_BRIEF.md
...
WEBINAR TRACKER (parallel — CRITICAL PATH):
- CPI assessment must be live and connected Aug 12
- Registration → assessment → post-assessment CTA flow (briefing invite)
- Work with Akira (diagnostic design) and Valentina (website integration)
- https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/WEBINAR_TRACKER.md
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/MARIA_BRIEF.md

READ FIRST:
- Brand Constitution: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CONSTITUTION.md
- Brand Checklist: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CHECKLIST.md

WHAT YOU OWN: Outreach — cold email, partnerships, introductions, referral programs, all direct outbound communication. You own the first-touch templates and sequences that go directly to prospects and partners. LENS gives you audience segments; ECHO gives you content materials; you execute the outreach.
...
NEAREST DEADLINES:
- Days 2-3 (today-tomorrow): Audit all existing outreach templates and sequences
- Day 5 (Aug 10): All core outreach templates updated with new positioning
- Day 6-7 (Aug 11-12): Partner/referral materials updated
- Aug 14: Webinar #1 outreach sequence ready to send

WEBINAR TRACKER (parallel):
- Webinar #1 outreach sequence — cold + partner + warm list
- Work with LENS on audience segmentation, ECHO on copy
- https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/WEBINAR_TRACKER.md
...
## FOR LENS (Audience and Signals Matching)
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/LENS_BRIEF.md

READ FIRST:
- Brand Constitution: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CONSTITUTION.md
- Brand Checklist: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CHECKLIST.md

WHAT YOU OWN: Audience strategy and signals matching — who we target, how we segment them, which signals indicate readiness, how we match content to audience stage. You are not KPI dashboards (that's a byproduct). You own the audience intelligence that drives everything downstream: who gets what, when, and why.
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/HANS_BRIEF.md
...
NEAREST DEADLINES:
- Days 1-2 (today): Research paper scope + outline + methodology
- Day 3-4 (Aug 8-9): Data gathering and analysis phase
- Day 5-6 (Aug 10-11): First full draft
- Day 7 (Aug 12): Final draft ready for Kevin review

WEBINAR TRACKER (parallel):
- Webinar #1 data verification — all claims sourced and verified
- Q&A backup data and research references
- Research paper teaser for webinar promotion
- https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/WEBINAR_TRACKER.md
...
## FOR CARL (Repurposing and Social Media Asset)
...
YOUR BRIEF: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/CARL_BRIEF.md

READ FIRST:
- Brand Constitution: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CONSTITUTION.md
- Brand Checklist: https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/BRAND_CHECKLIST.md

WHAT YOU OWN: Content repurposing and social media assets — taking long-form content (from ECHO, from Hans) and turning it into social posts, carousels, LinkedIn articles, newsletters, short-form video scripts, and all distribution assets. You also own the publishing cadence and the actual posting.

KEY POINTS:
- You take what ECHO produces (long-form, templates, core copy) and repurpose it into 5-10 distribution formats
- You own LinkedIn company page publishing, partner profile updates, newsletter production
...
- Day 5 (Aug 10): First batch of repurposed social assets from ECHO's website copy
- Day 6 (Aug 11): LinkedIn profiles ready to publish (all 4 partners + company page)
- Day 7 (Aug 12): First newsletter under new branding goes out + profiles go live

WEBINAR TRACKER (parallel):
- Webinar #1 promo content: 5 LinkedIn posts, 3 carousels, newsletter feature
- Promo schedule: Aug 12-19, daily cadence
- https://github.com/kevinhongfr-star/lyc-intelligence/blob/main/brand-rollout/agents/WEBINAR_TRACKER.md
