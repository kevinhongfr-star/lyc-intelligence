...
const handlers: Record<string, () => Promise<any>> = {
  ...
  'cpi': () => import('./_lib/cpiHandler.js').then(m => ({ handler: m.handleCpi })),
  ...
  'matching': () => import('./_lib/matchingHandler.js').then(m => ({ handler: m.handleMatching })),
  'score': () => import('./_lib/scoreHandler.js').then(m => ({ handler: m.handleScore })),
  'signals': () => import('./_lib/signalsHandler.js'),
  'trident': () => import('./_lib/tridentHandler.js').then(m => ({ handler: m.handleTrident })),
  ...
  'canvas': () => import('./_lib/canvasHandler.js').then(m => ({ handler: m.handleCanvas })),
  'grid': () => import('./_lib/gridHandler.js').then(m => ({ handler: m.handleGrid })),
  'grid-reports': () => import('./_lib/gridReportsGenerateHandler.js').then(m => ({ handler: m.handler })),
  'scoring': () => import('./_lib/scoringComputeHandler.js').then(m => ({ handler: m.handler })),
  'reports': () => import('./_lib/reportsHandler.js').then(m => ({ handler: m.handleReports })),
  'coaching': () => import('./_lib/coachingHandler.js').then(m => ({ handler: m.handleCoaching })),
  'client-portal': () => import('./_lib/clientPortalHandler.js').then(m => ({ handler: m.handleClientPortal })),
  'client-workflow': () => import('./_lib/clientWorkflowEngine.js').then(m => ({ handler: m.handleClientWorkflow })),
  'client-engagement': () => import('./_lib/clientEngagementHandler.js').then(m => ({ handler: m.handleClientEngagement })),
  'candidates': () => import('./_lib/candidatesHandler.js').then(m => ({ handler: m.handleCandidates })),
};
