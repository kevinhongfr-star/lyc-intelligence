-- ============================================================
-- DEX AI / LYC Intelligence — Master Migration Script V2
-- Generated: 2026-07-03 17:20 UTC
-- FIX: corrected JSONB index syntax error in milestones migration
--
-- PURPOSE: Execute all pending database migrations + fix profiles
-- INSTRUCTIONS: Copy entire file into Supabase SQL Editor and run.
--
-- This script will:
-- 1. Create/ensure the profiles table exists with proper schema
-- 2. Add auto-profile-creation trigger for new signups
-- 3. Auto-confirm existing user kevin@lyc-partners.ai
-- 4. Create super_admin profile for Kevin
-- 5. Run all 44 pending schema migrations (IF NOT EXISTS safe)
-- ============================================================
...
-- Auto-confirm existing user kevin@lyc-partners.ai
UPDATE auth.users
...
-- Create/update super_admin profile for Kevin
INSERT INTO public.profiles (id, email, full_name, role)
VALUES (
