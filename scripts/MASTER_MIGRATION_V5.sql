...
-- ============================================================
enerated column,
--         dependency ordering (organizations before references)
--
...
-- ============================================================
-- PART 0: PREREQUISITE TABLES (created first due to dependencies)
-- ============================================================
...
-- 0b: organizations table (must exist before many migrations reference it)
...
-- 0c: Auto-confirm Kevin's account (confirmed_at is generated, only set email_confirmed_at)
UPDATE auth.users
SET email_confirmed_at = now()
WHERE email = 'kevin@lyc-partners.ai'
  AND email_confirmed_at IS NULL;

-- 0d: Create super_admin profile for Kevin
...
-- ============================================================
-- PART 1: All migrations (IF NOT EXISTS safe)
-- ============================================================
